...
public class GameWindow
{
    ...
    public GameWindow(String title, int width, int height){
        this.wndTitle    = title;    /*!< Retine titlul ferestrei.*/
        this.wndWidth    = width;    /*!< Retine latimea ferestrei.*/
        this.wndHeight   = height;   /*!< Retine inaltimea ferestrei.*/
        this.wndFrame    = null;     /*!< Fereastra nu este construita.*/
    }
